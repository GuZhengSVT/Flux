...
| 平台体验/资源占用/可访问性 | 架构第 7、8 节 | T049–T052 | DOING（**T049 DONE 但范围收窄**：键盘导航/右键菜单/读屏语义/大字号与窄窗回归/SET-014 真实生效已交付，见 R049；macOS 原生菜单栏、输入法、窗口与后台生命周期、权限/Keychain 复测、profile/release 记录与真实 VoiceOver 人工走查**未做**，记 REVIEW。**T050 单内的性能基线已执行**（macOS debug，见 R050 与 §7.2 基线行）；**手册 T050 的 Android 部分仍 TODO**。T051/T052 未开始） |
