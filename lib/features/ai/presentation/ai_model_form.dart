...
//
//   2) **未实现的协议在选择项里就标注**。判据来自协议本身的数据字段
//      （AiProtocol.hasAdapter），而不是一个写死的协议名判断：T025 期间
//      Anthropic Messages 的选项带「（适配器待实现）」，T027 落地适配器后这个后缀
//      自动消失。将来新增「先登记协议、适配器留给后续任务」的条目时会自动生效。
//
