...
// T018 改为 v5 基线，T019+ 改为 v6 基线）：迁移安全。
//
...
// 删除事件表）、T019+ 提到 6（文章表补卡片图片地址）后，本文件里的「当前版本」
// 相应改为 6，而「代码比库新但迁移写坏」的场景用**比当前版本再高一级**的坏实现
// 模拟（现为 v7）；真正的增量迁移正确性由 migration_v1_to_v2_test.dart、
// migration_v2_to_current_test.dart、migration_v4_to_v5_test.dart 与
// migration_v5_to_v6_test.dart 用 drift 快照校验。
//
